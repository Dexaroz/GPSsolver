...
def branch_and_bound_search_with_subestimation(problem, locations):
    """Search the optimal path without subestimation."""
    return graph_search(problem, PriorityQueue2(problem.goal, locations))
